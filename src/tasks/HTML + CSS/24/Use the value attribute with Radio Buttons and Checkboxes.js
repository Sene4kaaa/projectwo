...
//         <label htmlFor="lazy"><input id="lazy" type="checkbox" name="personality"> Lazy</label>
//         <label htmlFor="energetic"><input id="energetic" type="checkbox" name="personality"> Energetic</label><br>
